  ...
  return (
    <section className={classes.detailBox}>
      ...
      <div className={classes.apply_box}>
        <a className={classes.apply_button} href="{wantedInfoUrl}">
          홈페이지 지원
        </a>
      ...
      <div className={classes.apply_content}>
        <p>
          ...
          <br />
          나. 채용형태 : 계약일로부터∼1년(1년 단위 연장 및 재계약 가능)
          <br />
          <br />
          다. 응시자격 및 우대사항
          <br />
          - 응시자격 : 학사(4년제 정규대학 졸업) 이상의 경력이 인정되며 변리사
          자격증(등록변리사) 소지자
          <br />
          - 우대사항 : 공공기관 근무 경력자 및 지식재산 관련 업무 경력자
          <br />
          <br />
      ...
      >
        ...
        <dl
          className={classNames({
            [classes.tbList]: true,
            [classes.apply_dday__content]: true,
          })}
        >
          <dt>시작일: </dt>
          <dd>2020.30.55</dd>
